 ...
 */
abstract class VisionProcessorBase2<T>(context: Context) : VisionImageProcessor2 {
    ...
    override fun processBitmap(bitmap: Bitmap?, graphicOverlay: GraphicOverlay?, bitmapId: Int) {
        ...
        return task
            .addOnSuccessListener(
                ...
                OnSuccessListener { results: T ->
                    ...
                    this@VisionProcessorBase2.onSuccess(results, graphicOverlay,bitmapIdX)
          ...
          """.trimIndent(),
                    ...
                    Log.d(TAG, error)
                    e.printStackTrace()
                    this@VisionProcessorBase2.onFailure(e)
                }
            )
    }
    ...
    protected abstract fun onSuccess(results: T, graphicOverlay: GraphicOverlay,bitmapId: Int)
