 ...
 */
class FaceGraphic constructor(overlay: GraphicOverlay?,
                              private val isRealFace: Boolean,
                              private val face: Face) : GraphicOverlay.Graphic(overlay) {
  ...
  override fun draw(canvas: Canvas) {
    ...
    val rectanglePaint = Paint().apply {
      color = if (isRealFace) Color.GREEN else Color.RED
